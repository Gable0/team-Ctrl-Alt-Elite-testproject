...
class AudioManager {
      ...
      if (fade) {
        ...
        this.currentMusic
          ...
          .catch((err) => {
            ...
            console.log("This might be due to autoplay restrictions. Try interacting with the page.");
          });
      } else {
  ...
  fadeIn() {
    ...
    this.fadeInterval = setInterval(() => {
      ...
      currentStep++;
      this.currentMusic.volume = Math.min(currentStep * volumeIncrement, this.musicVolume);
